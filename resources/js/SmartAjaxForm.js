					...
					onComplete: function(response) {
						...
						if(response != null)
						{
							var myRequest = new Request({
								method: 'get',
								url: 'http://localhost/harbor-web/index.php/import/initialize?import_dir='+response,
							...
							while(length >= 1)	
							{
								...
								var req = new Request.HTML({
									method: 'post',
									url: 'http://localhost/harbor-web/index.php/import/initialize?import_files='+response,									
									//update: $('progressbar'),
									//onComplete: function(response) { 
